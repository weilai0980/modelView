...
//			stat[tnum++][1] = qualnum;
	...
	public void tpExp(int num) throws Exception {
		...
		textRecordExp_clear("./result/tpExpMrk.txt");
		...
		for (int i = 0; i < num; ++i) {
			...
			kviTemp.kvi_pointSearch_mr(inte[0], qual, 0);
			stat[tnum][0] = tmpstat[0]; // tdur
...
//			stat[tnum++][0] = stopCnt();
			...
			textRecordExp("./result/tpExpMrk.txt", stat, tuprange, tnum,
					inte[0]);
		}
	...
	public void viExp(int num) throws Exception {
		...
		textRecordExp_clear("./result/viExpItKviMr.txt");
		...
		for (int i = 0; i < num; ++i) {
			...
			textRecordExp("./result/viExpItKviMr.txt", stat, tuprange, tnum,
					inte[0], inte[1]);
		}
	...
	public void vpExp(int num) throws Exception {
		...
		for (int i = 0; i < num; ++i) {
			...
			textRecordExp("./result/vpExpRawMR.txt", stat, tuprange, tnum,
					inte[0]);
		}
		return;
	}
