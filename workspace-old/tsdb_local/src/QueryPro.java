...
public class QueryPro {
	...
	public static void main(String[] args) {
		...
		// System.out.print("fafdafafadfasf");
		...
		System.out.println("raw data model done \n");

		olfio = new onlineFileIO();

		olfio.ImportFolder("/home/guo/workspace/dataset3", "2010-04-16", 1);
		System.out.println("model1 done \n");

		olfio = new onlineFileIO();

		olfio.ImportFolder("/home/guo/workspace/dataset3", "2010-04-16", 2);
		System.out.println("model2 done \n");
