...
public class kviManEnhan {
	...
	public kviManEnhan(String tabname, boolean startIdx, int sign)
	...
	// return true;
	// }
	public boolean kvi_rangeSearchEnhan(double l, double r, String qual[],
			int sign)// 0:
			// temp,
			// 1:value
			throws Exception {
	...
	public boolean kvi_rangeSearchScanPerReg(double l, double r, String qual[],
			int sign)// 0:
			// temp,
			// 1:value
			throws Exception {
	...
	public boolean kvi_rangeSearchIndiviPerReg(double l, double r, String qual[],
			int sign)// 0:
			// temp,
			// 1:value
			throws Exception {
		...
		stcnt = System.nanoTime();
		int relregnum = kviCol.relIndiviRegIntervalSearch(l, r, releReg,nodeinReg,nodeinRegCnt);

//		relIndiviRegIntervalSearch(double l, double r, long relreg[],
//				double relregNode[][],int relregNodeCnt[])
...
//		kviMRproCol.numMapIn = 0;
		...
		RegIndiviTableInputFormat.getRegion(relregnum, releReg, nodeinReg,nodeinRegCnt);
