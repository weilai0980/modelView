...
public class scanProCol {
	...
	public void model_grid(double domain[], String[] model) {
		...
		double step = (domain[1] - domain[0]) / gridstep;
	...
	public double pointSearch_scan(String tabname, String[][] indi, double val,
		...
		for (int i = 0; i < pointnum; ++i) {
			...
			//	valPaser_kvi(str, bound);
				...
				bound[1]=Double.parseDouble(tabOper.scanGet("attri",qual[1]));
	...
	public double rangeSearch_scanNoGrid(String tabname, String[][] indi, double l,
			double r, int pointnum, String qual[]) {
	...
	//..................for traditional interval index..................//
	public double rangeSearch_interRangeScan(String tabname, double l, double r) {
