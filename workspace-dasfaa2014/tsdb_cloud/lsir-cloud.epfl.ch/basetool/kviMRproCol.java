...
public class kviMRproCol {
	...
	static class MapperTempPoint extends TableMapper<ImmutableBytesWritable, Text> {
	...
	static class MapperValPoint extends TableMapper<ImmutableBytesWritable, Text> {
