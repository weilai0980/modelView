...
public class MRtest1 {
	...
	public static class mapValPointTest1 extends TableMapper<ImmutableBytesWritable, Text> {
	...
	public void jobValPoint(double val, String idxtabname) throws Exception {
		...
		Job a= new Job();
		job.setJarByClass(MRtest1.class);
		...
		TableMapReduceUtil.initTableMapperJob(idxtabname, scan,
				mapValPointTest1.class, ImmutableBytesWritable.class, Text.class,
				job);
